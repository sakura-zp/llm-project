      ...
      <div class="side-nav">
        <a-affix :offset-top="80">
          <a-menu mode="inline" :selected-keys="[activeSection]" @click="scrollToSection">
            ...
            <a-menu-item key="train" v-if="tripPlan.train_info">
              <span>🚄 火车信息</span>
            </a-menu-item>
            <a-menu-item key="map">
              <span>📍 景点地图</span>
          ...
          <div class="left-info">
            ...
            <a-card id="budget" v-if="tripPlan.budget" title="💰 预算明细" :bordered="false" class="budget-card">
              <div class="budget-grid">
                ...
                <div class="budget-item" v-if="tripPlan.budget.train_tickets > 0">
                  <div class="budget-label">🚄 往返车票</div>
                  <div class="budget-value budget-highlight">¥{{ tripPlan.budget.train_tickets }}</div>
                </div>
              </div>
            ...
            <!-- 火车信息 -->
            <a-card id="train" v-if="tripPlan.train_info" title="🚄 火车信息" :bordered="false" class="train-card">
              <a-descriptions :column="2" size="small" bordered>
                <a-descriptions-item label="推荐车次" :span="2">
                  <span class="train-number">{{ tripPlan.train_info.recommended_train }}</span>
                </a-descriptions-item>
                <a-descriptions-item label="出发时间">{{ tripPlan.train_info.departure_time }}</a-descriptions-item>
                <a-descriptions-item label="到达时间">{{ tripPlan.train_info.arrival_time }}</a-descriptions-item>
                <a-descriptions-item label="耗时" :span="2">{{ tripPlan.train_info.duration }}</a-descriptions-item>
                <a-descriptions-item label="二等座">
                  <span class="price-highlight">¥{{ tripPlan.train_info.second_class_price }}</span>
                </a-descriptions-item>
                <a-descriptions-item label="一等座" v-if="tripPlan.train_info.first_class_price">
                  ¥{{ tripPlan.train_info.first_class_price }}
                </a-descriptions-item>
                <a-descriptions-item label="商务座" v-if="tripPlan.train_info.business_class_price" :span="2">
                  ¥{{ tripPlan.train_info.business_class_price }}
                </a-descriptions-item>
              </a-descriptions>
              <div class="train-note">
                <small>💡 以上为单程票价，往返票价已计入预算总费用</small>
              </div>
            </a-card>
          </div>
